...
<?php  
	...
	$aksi = new oop();//untuk memanggil di library
...
<html>
<head>
	<title>FORM LOGIN AGUNG PAY</title>
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 5px;">
								<img src="../images/logoagungpay.png" alt="logo" class="logo" width="90px">
							</div>
							<div style="margin-left: 110px; margin-top: -40px; font-size: 120%;">
